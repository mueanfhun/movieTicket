...
class showdetailJazz extends Component {
  ...
  render() {
    ...
    return ( 
       ...
       <img  className="card-img" src={(this.props.datamovie)? this.props.datamovie.data[4].image : ''} />
        <div class="card-body">
        <h2 className="card-title text-center">{(this.props.datamovie)? this.props.datamovie.data[4].name : ''}</h2>
          <p className="card-text text-center">{(this.props.datamovie)? this.props.datamovie.data[4].shot_description : ''}</p>
        </div>
        </div>
