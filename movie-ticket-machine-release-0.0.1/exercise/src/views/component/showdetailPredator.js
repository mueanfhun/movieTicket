...
class showdetailPredator extends Component {
  ...
  render() {
    ...
    return ( 
       ...
       <img  className="card-img" src={(this.props.datamovie)? this.props.datamovie.data[10].image : ''} />
        <div class="card-body">
        <h2 className="card-title text-center">{(this.props.datamovie)? this.props.datamovie.data[10].name : ''}</h2>
          <p className="card-text text-center">{(this.props.datamovie)? this.props.datamovie.data[10].shot_description : ''}</p>
        </div>
        </div>
